            ...
            <div class="portlet-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1_1">
                        <form id="form_profile" role="form" action="<?php echo base_url('user/change_infor'.'/'.$current_user->id) ?>" method="POST">
                            <div class="form-group">
                                <label class="control-label"> Họ và tên đệm </label>
                                <input type="text" placeholder=" Nguyễn Quỳnh " class="form-control" name="first_name" value="<?php echo $current_user->first_name ?>" /> 
                            </div>
                            <div class="form-group">
                                <label class="control-label"> Tên </label>
                                <input type="text" placeholder=" Trâm " class="form-control" name="last_name" value="<?php echo $current_user->last_name ?>" /> 
                            </div>
                            <div class="form-group">
                                <label class="control-label">Email</label>
                                <input type="text" placeholder="nguyenquynhtram@email.com" class="form-control" value="<?php echo $current_user->email ?>" readonly/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="tab-pane" id="tab_1_2">
                        <form id="form_password" action="<?php echo base_url('user/change_password'.'/'.$current_user->id) ?>" role="form" method="POST">
                            <div class="form-group">
...
<script src="<?php echo asset_url() ?>pages/scripts/work_time/profile.js"></script>
